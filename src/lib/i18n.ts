...
export const messages = {
    ...
    transactions: {
        ...
        detail: {
            ...
            refund: {id: "transactions.detail.refund", defaultMessage: "退款"},
            refundTitle: {id: "transactions.detail.refundTitle", defaultMessage: "退款"},
            refundDescription: {id: "transactions.detail.refundDescription", defaultMessage: "退款會建立一筆關聯交易，並扣減原交易淨額。"},
            refundAmount: {id: "transactions.detail.refundAmount", defaultMessage: "退款金額"},
            refundCapHint: {id: "transactions.detail.refundCapHint", defaultMessage: "可退款上限 {amount}"},
            refundOccurredAt: {id: "transactions.detail.refundOccurredAt", defaultMessage: "退款時間"},
            refundNote: {id: "transactions.detail.refundNote", defaultMessage: "備註"},
            refundSubmit: {id: "transactions.detail.refundSubmit", defaultMessage: "確認退款"},
            refundExceedsCap: {id: "transactions.detail.refundExceedsCap", defaultMessage: "退款金額不可超過 {amount}"},
            refundFullyRefunded: {id: "transactions.detail.refundFullyRefunded", defaultMessage: "此交易已全數退款"},
            refundTransferNotAllowed: {id: "transactions.detail.refundTransferNotAllowed", defaultMessage: "轉帳不可退款"},
            refundOfRefundNotAllowed: {id: "transactions.detail.refundOfRefundNotAllowed", defaultMessage: "退款記錄不可再退款"},
