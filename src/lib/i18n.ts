...
export const messages = {
    ...
    transactions: {
        ...
        list: {
            ...
            refund: {id: "transactions.list.refund", defaultMessage: "退款"},
        ...
        detail: {
            ...
            originalAmount: {id: "transactions.detail.originalAmount", defaultMessage: "原始金額"},
            netAmount: {id: "transactions.detail.netAmount", defaultMessage: "扣除退款後淨額"},
            ...
            refundOf: {id: "transactions.detail.refundOf", defaultMessage: "原交易"},
    ...
    dashboard: {
        ...
        refund: {id: "dashboard.refund", defaultMessage: "退款"},
