...
import {SummaryDailyChart} from "@/features/summaries/SummaryDailyChart";
    ...
    const renderBody = () => {
        ...
        return (
            <Stack gap="5">
                ...
                {period !== "daily" ? <SummaryDailyChart daily={summary.daily} date={date} period={period} netCents={summary.net_cents} /> : null}
